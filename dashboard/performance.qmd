...
reference_datetimes <- 
  duckdbfs::open_dataset(paste0("s3://",config$forecasts_bucket,
...
reference_datetimes <- reference_datetimes |> 
  mutate(reference_datetime_max = reference_datetime_max - lubridate::days(1))
...
df <- duckdbfs::open_dataset(paste0("s3://",config$scores_bucket,
                                                     "/bundled-parquet/"),
                                              s3_endpoint = "amnh1.osn.mghpcc.org",
                                              anonymous = TRUE) |> 
  #arrow::open_dataset(s3_scores) |> 
  filter(duration == 'P1D', 
